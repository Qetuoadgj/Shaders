...
//
#define HD6_COLOR_TWEAKS		      1 //1	// Enables a set of Contrast, Brightness and Saturation controls, with in-game adjustment.
...
//EXTERIOR									                 Night, Day
  float2	EBrightnessV2Ext	        = float2( 1.4, 1.4 );	//float2( 1.0, 1.0 );	//float2( 1.0, 1.0 );
  ...
  float2	EToneMappingOversatV2Ext  = float2( 8.0, 8.0 );	//float2( 1.0, 1.0 );	//float2( 1306.6, 2986.6 );
  float2	EBlacknessV2Ext		        = float2( 0.0, 0.0 );	//float2( 0.0, 0.0 );	//float2( 0.000001, 0.000001 );
  float2	EPostBrightnessV2Ext	    = float2( 1.4, 1.4 );	//float2( 1.0, 1.0 );	//float2( 0.816667, 0.933334 );
...
#if (HD6_COLORSAT==1)
//EXTERIOR						           Red, Green, Blue
  float3 RGBSatExtDay 	= float3( 1, 1, 1 );  //float3( 1, 1, 1 );
  float3 RGBSatExtNight = float3( 1, 1, 1 );  //float3( 1.0625, 0.96875, 0.96875 );

//INTERIOR						           Red, Green, Blue
  float3 RGBSatIntDay 	= float3( 1, 1, 1 );  //float3( 1, 0.975, 1.025 );
  float3 RGBSatIntNight = float3( 1, 1, 1 );  //float3( 1, 0.975, 1.025 );
#endif
