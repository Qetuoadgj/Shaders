...
//EXTERIOR {Night, Day}
  float2	EBrightnessV2Ext	        = float2( 1.2, 1.2 );	//float2( 1.0, 1.0 );	//float2( 1.0, 1.0 );
  float2	EIntensityContrastV2Ext	  = float2( 1.2, 1.2 );	//float2( 1.0, 1.0 );	//float2( 1.4, 1.4 );
  float2	EColorSaturationV2Ext	    = float2( 1.4, 1.4 );	//float2( 1.0, 1.0 );	//float2( 1.633334, 1.866667 );
  float2	EToneMappingCurveV2Ext	  = float2( 1.0, 1.0 );	//float2( 1.0, 1.0 );	//float2( 8.0, 8.0 );
  float2	EToneMappingOversatV2Ext  = float2( 4.0, 4.0 );	//float2( 1.0, 1.0 );	//float2( 1306.6, 2986.6 );
  float2	EBlacknessV2Ext		        = float2( 0.0, 0.0 );	//float2( 0.0, 0.0 );	//float2( 0.000001, 0.000001 );
  float2	EPostBrightnessV2Ext	    = float2( 1.2, 1.2 );	//float2( 1.0, 1.0 );	//float2( 0.816667, 0.933334 );
...
//INTERIOR {Red, Green, Blue}
  float3 RGBSatIntDay 	= float3( 1.15, 1.05, 1.05 );  //float3( 1, 1, 1 );  //float3( 1, 0.975, 1.025 );
  float3 RGBSatIntNight = float3( 1.15, 1.05, 1.05 );  //float3( 1, 1, 1 );  //float3( 1, 0.975, 1.025 );
#endif
